...
kotlin {
    ...
    val xcf = XCFramework("SupportsColor")

    macosArm64 {
        binaries.framework { baseName = "SupportsColor"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "SupportsColor"; xcf.add(this) }
    }
...
mavenPublishing {
    ...
    coordinates(group.toString(), "supports-color-kotlin", version.toString())

    pom {
        name.set("supports-color-kotlin")
        description.set("Kotlin Multiplatform port of zkat/supports-color - Detects whether a terminal supports color, and gives details about that support")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/supports-color-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/supports-color-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/supports-color-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/supports-color-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleSupportsColorXCFramework",
)
