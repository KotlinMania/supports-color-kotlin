...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `SupportsColor.swiftmodule/`
...
//      `import SupportsColor` above would fail at compile time.
//
//   2. The static archive `libSupportsColor.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "SupportsColor" }` and
//      `flattenPackage = "io.github.kotlinmania.supportscolor"` configuration in
...
//      via the `SupportsColorLibrary` product.
//
