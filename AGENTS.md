...
This file is the quick-reference operating contract for supports-color-kotlin. The longer
...
supports-color-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`supports-color`](https://crates.io/crates/supports-color). Upstream Rust is the behavioral oracle while the
